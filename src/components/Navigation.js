...
              <React.Fragment>
                  ...
                  <Button className="btn btn-primary"><NavLink to="/createpost">Create Post</NavLink></Button>
                  </NavItem>
                  <NavItem className="mt-2" style={{marginRight: "15px" }}>
                  <Button className="btn btn-primary"><NavLink to="/authposts">My Posts</NavLink></Button>
                  </NavItem>
  ...
  return (
    <div className="mb-3">
      <Navbar color="light" light expand="md"> 
        <NavbarBrand className="mx-auto" href="/"><span style={{ fontWeight: "bold"}}>Amex - SRE : Forum (Let's talk)</span></NavbarBrand>
